...
public class ESCUtil {
    ...
    public static byte[] selectBitmap(Bitmap bitmap, int mode) {
        return com.reactnativesunmiprinting.BytesUtil.byteMerger(
            com.reactnativesunmiprinting.BytesUtil.byteMerger(
                new byte[] { 0x1B, 0x33, 0x00 },
                com.reactnativesunmiprinting.BytesUtil.getBytesFromBitMap(bitmap, mode)
            ),
