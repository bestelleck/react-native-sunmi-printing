...
public class ESCUtil {
  ...
  public static byte[] getPrintDoubleQRCode(String qr1, String qr2, int size){
    ...
    byte[] bytes2 = com.reactnativesunmiprinting.BytesUtil.getZXingQRCode(qr1, qr2, size);
    return com.reactnativesunmiprinting.BytesUtil.byteMerger(bytes1, bytes2);
  }
  ...
  public static byte[] getPrintBarCode(String data, int symbology, int height, int width, int textposition){
    ...
    try{
      ...
      byte[] barcode;
      if(symbology == 10){
        barcode = com.reactnativesunmiprinting.BytesUtil.getBytesFromDecString(data);
      }else{
  ...
  public static byte[] printBitmap(Bitmap bitmap){
    ...
    byte[] bytes2 = com.reactnativesunmiprinting.BytesUtil.getBytesFromBitMap(bitmap);
    return com.reactnativesunmiprinting.BytesUtil.byteMerger(bytes1, bytes2);
  }
  ...
  public static byte[] printBitmap(byte[] bytes){
    ...
    return com.reactnativesunmiprinting.BytesUtil.byteMerger(bytes1, bytes);
  }
  ...
  public static byte[] selectBitmap(Bitmap bitmap, int mode){
    return com.reactnativesunmiprinting.BytesUtil.byteMerger(com.reactnativesunmiprinting.BytesUtil.byteMerger(new byte[]{0x1B, 0x33, 0x00}, com.reactnativesunmiprinting.BytesUtil.getBytesFromBitMap(bitmap, mode)), new byte[]{0x0A, 0x1B, 0x32});
  }
